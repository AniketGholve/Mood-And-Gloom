...
def upload():
    ...
    while True:
        ...
        #used to convert img to gray scale
...
def files_count():
    ...
    happy = 'D://Depression_Analysis//Depression_Analysis//dataset//Happy'
    ...
    fear = 'D://Depression_Analysis//Depression_Analysis//dataset//Fearful'
    ...
    sad = 'D://Depression_Analysis//Depression_Analysis//dataset//Sad'
    ...
    neutral = 'D://Depression_Analysis//Depression_Analysis//dataset//Neutral'
    ...
    Surprised = 'D://Depression_Analysis//Depression_Analysis//dataset//Surprised'
    ...
    Disgusted = 'D://Depression_Analysis//Depression_Analysis//dataset//Disgusted'
    ...
    if int(number_of_Happy_files) > int(number_of_Fear_files) and int(number_of_Happy_files) > int(number_of_sad_files) and int(number_of_Happy_files) > int(number_of_neutral_files):
        str_label="User Is Happy And No Symptoms of Gloom"
        print(str_label)
        ...
        str_label = "User Is In Fear And Some Symptoms of Gloom"
        print(str_label)
        ...
        str_label = "User Is In Neutral State"
        print(str_label)
        ...
        str_label = "User Is Sad And Mild Symptoms of Gloom"
        print(str_label)
        
    elif int(number_of_Disgusted_files) > int(number_of_Happy_files) and int(number_of_Disgusted_files) > int(number_of_neutral_files) and int(number_of_Disgusted_files) > int(number_of_Fear_files) and int(number_of_Disgusted_files) > int(number_of_sad_files):
        str_label = "High Symptoms of Gloom"
        print(str_label)
    return str_label