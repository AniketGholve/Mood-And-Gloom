...
image2 =image2.resize((1920,900), Image.ANTIALIAS)
...
lbl = tk.Label(window, text="Registration Form", font=('times', 35,' bold '), height=2, width=70,bg="moccasin",fg="black")
lbl.place(x=0, y=0)
...
l2 = tk.Label(frame, text="Full Name :", width=12, font=("Times new roman", 15, "bold"), bg="#BFEFFF",bd=5)
l2.place(x=30, y=30)
...
l3 = tk.Label(frame, text="Address :", width=12, font=("Times new roman", 15, "bold"), bg="#BFEFFF",bd=5)
l3.place(x=30, y=80)
...
l5 = tk.Label(frame, text="E-mail :", width=12, font=("Times new roman", 15, "bold"), bg="#BFEFFF")
l5.place(x=30, y=130)
t4 = tk.Entry(frame, textvar=Email, width=20, font=('', 15),bd=5)
t4.place(x=230, y=130)
# that is for email address

l6 = tk.Label(frame, text="Phone number :", width=12, font=("Times new roman", 15, "bold"), bg="#BFEFFF")
l6.place(x=30, y=180)
t5 = tk.Entry(frame, textvar=Phoneno, width=20, font=('', 15),bd=5)
t5.place(x=230, y=180)
# phone number
l7 = tk.Label(frame, text="Gender :", width=12, font=("Times new roman", 15, "bold"), bg="#BFEFFF")
l7.place(x=30, y=230)
# gender
tk.Radiobutton(frame, text="Male", padx=5, width=5, bg="#33A1C9", font=("bold", 15), variable=var, value=1).place(x=230,
                                                                                                                y=230)
tk.Radiobutton(frame, text="Female", padx=20, width=4, bg="#33A1C9", font=("bold", 15), variable=var, value=2).place(
    x=340, y=230)

l8 = tk.Label(frame, text="Age :", width=12, font=("Times new roman", 15, "bold"), bg="#BFEFFF")
l8.place(x=30, y=280)
t6 = tk.Entry(frame, textvar=age, width=20, font=('', 15),bd=5)
t6.place(x=230, y=280)

l4 = tk.Label(frame, text="User Name :", width=12, font=("Times new roman", 15, "bold"), bg="#BFEFFF")
l4.place(x=30, y=330)
t3 = tk.Entry(frame, textvar=username, width=20, font=('', 15),bd=5)
t3.place(x=230, y=330)

l9 = tk.Label(frame, text="Password :", width=12, font=("Times new roman", 15, "bold"), bg="#BFEFFF")
l9.place(x=30, y=380)
t9 = tk.Entry(frame, textvar=password, width=20, font=('', 15), show="*",bd=5)
t9.place(x=230, y=380)

l10 = tk.Label(frame, text="Confirm Password:", width=13, font=("Times new roman", 15, "bold"), bg="#BFEFFF")
