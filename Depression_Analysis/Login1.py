...
class login_system:
    ...
    # Create Widgets
        ...
        self.bg1_icon=ImageTk.PhotoImage(file=r"D:\Depression_Analysis\Depression_Analysis\L.png")

        self.bg_icon=ImageTk.PhotoImage(file=r"D:\Depression_Analysis\Depression_Analysis\L.png")
        self.user_icon=ImageTk.PhotoImage(file=r"D:\Depression_Analysis\Depression_Analysis\u1.png")
        self.pass_icon=ImageTk.PhotoImage(file=r"D:\Depression_Analysis\Depression_Analysis\p1.png")
        
        bg_lbl=Label(self.root,image=self.bg1_icon).pack()
        
        title=Label(self.root, text="LOG IN", font=("Times new roman", 40, "bold"), bg="lightseagreen",fg="white",bd=5,relief=RAISED)
        title.place(x=0, y=0,relwidth=1)
        
        Login_frame=Frame(self.root,bg="#FDF5E6")
        ...
        btn_log=Button(Login_frame,text="Login",command=self.login,width=15,font=("Times new roman", 14, "bold"),bg="deepskyblue1",fg="black").grid(row=3,column=1,pady=10)
    ...
    def login(self):
        ...
        if result:
            ...
            call(['python','Depression_Analysis.py'])
